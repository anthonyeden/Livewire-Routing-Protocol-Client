...
class LWRPClient():
    """ This class provides a friendly API for the Livewire Routing Protocol """
    ...
    def waitForCallback(self, timeout = 5):
        """ This function waits for data to be returned from the Comms class """
    ...
    def meterData(self): 
        """ Gets the current audio level meter data """
    ...
    def setSilenceThreshold(self, io, chnum, threshold, timems): 
        """ Sets a silence threshold and time for a specific I/O channel """
    ...
    def setClippingThreshold(self, io, chnum, threshold, timems): 
        """ Sets a clipping threshold and time for a specific I/O channel """
